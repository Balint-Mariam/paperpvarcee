...
STAGE_SCRIPTS <- c(
  reduced_form = "15_structural_pvar_full7_final_workflow.R",
  structural_refined4 = "17_structural_pvar_full7_refined4.R",
  historical_decomposition = "19_structural_pvar_full7_hd_refined4.R",
  counterfactual = "20_structural_pvar_full7_counterfactual_refined4.R"
)
...
if (file.exists("00_master_pipeline_full_paper.R")) file.copy("00_master_pipeline_full_paper.R", file.path(CODE_DIR, "00_master_pipeline_full_paper.R"), overwrite = TRUE)
