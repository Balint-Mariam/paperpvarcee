...
## 1. Data Construction
The final model-ready data are read from `outputs/01_model_ready_data/model_ready_dataset.xlsx`. The final panel contains 11 countries, 47 quarters and 517 observations.
