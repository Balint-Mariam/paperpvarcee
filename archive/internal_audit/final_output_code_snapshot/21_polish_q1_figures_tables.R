...
MAIN_POLISHED_DIR <- file.path(FIGURE_DIR, "main_paper_polished")
APPENDIX_POLISHED_DIR <- file.path(FIGURE_DIR, "appendix_polished")
...
APPENDIX_WB <- file.path(MASTER_DIR, "MASTER_appendix_tables.xlsx")
...
openxlsx::write.xlsx(list(table_manifest = table_manifest), file.path(MASTER_DIR, "table_manifest_polished.xlsx"), overwrite = TRUE)
